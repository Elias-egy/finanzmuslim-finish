...
Die [Prüfmatrix](anbieter-pruefmatrix.tsv) enthält 225 konkrete Merkmalszeilen mit Rohwert, vorhandener Beleg-URL, Finanzfluss-Linkkennung und nächstem Belegweg. Davon sind 124 im Rohimport offen. Die Matrix ist ein Snapshot; die Korrekturschicht kann Laufzeitwerte ändern und muss bei der nächsten Datenerzeugung in den Export integriert werden. Kaufbarkeit bleibt pro ISIN separat zu dokumentieren.
...
- **P1:** 24 Giro-Dispo- und 22 Krypto-Bezahlmodellwerte waren im Rohbestand offen. Für SumUp kommen alle relevanten Merkmale hinzu.
